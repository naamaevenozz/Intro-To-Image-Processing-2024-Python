...
"""
print([[1/9, 1/9, 1/9], [1/9, 1/9, 1/9], [1/9, 1/9, 1/9]]==blur_kernel(3))
...
image = [[[1, 2, 3], [1, 2, 3], [1, 2, 3]],
 ...
 [[1, 2, 3], [1, 2, 3], [1, 2, 3]],
 [[1, 2, 3], [1, 2, 3], [1, 2, 3]]]
print(combine_channels(image_lst)==image)

#separate_channels(image_lst)
#print(separate_channels(image))
#print(separate_channels(image)==image_lst)
#print(str(image)+str(len(image)))
#print(str(image[0])+str(len(image[0])))
#print(str(image[0][0])+str(len(image[0][0])))
"""